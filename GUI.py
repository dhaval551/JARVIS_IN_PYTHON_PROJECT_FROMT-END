...
from PyQt5.QtGui import QTextCharFormat, QIcon, QPainter, QFont, QMovie, QColor, QTextBlockFormat, QPixmap
...
GraphsDirpath = rf"{current_dir}\Frontend\Graphics"
...
def GraphicsDirectoryPath(Filename):
    path = rf'{GraphsDirpath}\{Filename}'
    return path
...
class CustomTopbar(QWidget):
    ...
    def showMessagescreen(self):
        ...
        self.current_widget = message_screen
    ...
    def showInitialScreen(self):
        ...
        self.current_widget = initial_screen
